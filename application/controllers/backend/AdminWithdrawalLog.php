<?php
class AdminWithdrawalLog extends MY_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('AdminWithdrawalLog_model');
    }
    ...
    public function index()
    {
        $data = [
            ...
            'Pending' => $this->AdminWithdrawalLog_model->WithDrawal_list(0),
            'Approved' => $this->AdminWithdrawalLog_model->WithDrawal_list(1),
            'Rejected' => $this->AdminWithdrawalLog_model->WithDrawal_list(2)
        ];

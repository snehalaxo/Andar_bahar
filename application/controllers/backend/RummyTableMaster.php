...
class RummyTableMaster extends MY_Controller
{
    ...
    {
        $data = [
            'title' => 'Rummy Table Master Management',
            'AllRummyTableMaster' => $this->RummyTableMaster_model->AllTableMasterList()
        ];
        $data['SideBarbutton'] = ['backend/RummyTableMaster/add', 'Add Rummy Table Master'];
    ...
    public function delete($id)
    {
        if ($this->RummyTableMaster_model->Delete($id)) {
            $this->session->set_flashdata('msg', array('message' => 'Rummy Table Master Removed Successfully', 'class' => 'success', 'position' => 'top-right'));
        } else {
    ...
    public function insert()
    {
        ...
        if ($RummyTableMaster) {
            $this->session->set_flashdata('msg', array('message' => 'Rummy Table Master Added Successfully', 'class' => 'success', 'position' => 'top-right'));
        } else {
            $this->session->set_flashdata('msg', array('message' => 'Somthing Went Wrong', 'class' => 'error', 'position' => 'top-right'));
        }
        redirect('backend/RummyTableMaster');
    ...
    public function update()
    {
        ...
        if ($RummyTableMaster) {
            $this->session->set_flashdata('msg', array('message' => 'Rummy Table Master Wallet Updated Successfully', 'class' => 'success', 'position' => 'top-right'));
        } else {
            $this->session->set_flashdata('msg', array('message' => 'Somthing Went Wrong', 'class' => 'error', 'position' => 'top-right'));
        }
        redirect('backend/RummyTableMaster');

                ...
                <table class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('backend/retailer/view/' . $User->id) ?>" class="btn btn-info"
                                    data-toggle="tooltip" data-placement="top" title="View Wins"><span
                                        class="fa fa-eye"></span></a>
                                | <a href="<?= base_url('backend/retailer/edit/' . $User->id) ?>" class="btn btn-info"
                                    data-toggle="tooltip" data-placement="top" title="Edit"><span
                                        class="fa fa-edit"></span></a>
                                | <a href="<?= base_url('backend/retailer/delete/' . $User->id) ?>" class="btn btn-danger"

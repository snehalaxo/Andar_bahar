...
class Batch_model extends MY_Model
{
    ...
    //     return true;
      ...
      public function andar_card($batch_id)
    {
        ...
        // $this->db->select('ax_batch.date','ax_batch.id','ax_andar_card.*');
        // $this->db->from('ax_andar_card');
        // $this->db->join('ax_batch', 'ax_batch.id=ax_andar_card.batch_id');
        // $this->db->where('ax_andar_card.batch_id',$batch_id);
        // $this->db->where('ax_batch.date',' >=',$date);

        // $Query = $this->db->get();
        // return $Query->result();
        
    }
     public function bahar_card($batch_id)
    {
